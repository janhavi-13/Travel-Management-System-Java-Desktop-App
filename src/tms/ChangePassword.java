...
public class ChangePassword extends JFrame implements ActionListener{
    ...
    ChangePassword(String username){
        ...
        ImageIcon i = new ImageIcon(ClassLoader.getSystemResource("tms/icons/changePass.jpg"));
        ...
        setLayout(null);
        setUndecorated(true);
        ImageIcon bi = new ImageIcon(ClassLoader.getSystemResource("tms/icons/travel3.jpg"));
        ...
        l1.setBounds(80,220,300,35);
        l1.setForeground(Color.BLACK);
        l1.setFont(new Font("Georgia",Font.BOLD,25));
        la.add(l1);
        
        t1 = new JPasswordField();
        t1.setBounds(80,260,270,30);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("tms/icons/view2.jpg"));
        Image i2 = i1.getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH);
        i3 = new ImageIcon(i2);
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("tms/icons/nView.png"));
        Image i5 = i4.getImage().getScaledInstance(30,30,Image.SCALE_SMOOTH);
        i6 = new ImageIcon(i5);
        
        b3 = new JButton(i3);
        b3.setBounds(350,260,25,30);
        ...
        l2.setBounds(80,310,300,35);
        l2.setForeground(Color.BLACK);
        l2.setFont(new Font("Georgia",Font.BOLD,25));
        la.add(l2);
        
        t2 = new JPasswordField();
        t2.setBounds(80,350,270,30);
        ...
        l3.setBounds(80,400,300,35);
        l3.setForeground(Color.BLACK);
        l3.setFont(new Font("Georgia",Font.BOLD,25));
        la.add(l3);
        
        t3 = new JPasswordField();
        t3.setBounds(80,440,270,30);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==b1){
             try{
                String oPassword = t1.getText();
                String sql = "select * from password where  userName= '"+username+"'AND password = '"+oPassword+"'";
                ResultSet rs = c.s.executeQuery(sql);
                if(rs.next()){      //if true means values are returning
                    String nPassword="";
                    if(t2.getText().equals(t3.getText())){
                        nPassword = t3.getText();
                        String query =  "update password set password= '"+nPassword+"'";
